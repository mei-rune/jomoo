...
data_block::data_block( char* msg_data, size_t len , Message_Flags flag , BT_Memory_Base* allocator )
: cur_size_( len )
, max_size_( len )
, base_( msg_data )
, flags_( flag )
...
BT_Memory_Base *data_block::get_Memory_Manager( )
{
	return allocator_;
}
...
message_block::message_block(  char* msg_data, size_t len , Message_Flags flag , BT_Memory_Base* allocator )
: data_block_( 0 )
, rd_size_( 0 )
, flags_( USER_FLAGS )
, allocator_( allocator )
...
message_block::message_block( data_block* data , Message_Flags flag , BT_Memory_Base* allocator )
: data_block_( data )
, rd_size_( 0 )
, flags_( flag )
, allocator_( allocator )
