...
static void IPSeg_Match(sqlite3_context *context, int argc, sqlite3_value **argv)
{
	if( argc != 3 )
	{
		tsqlite3_result_int( context, -1 );
	...
	int t =   tsqlite3_value_int64(argv[0]);
	int begin =   tsqlite3_value_int64(argv[1] );
	int end = tsqlite3_value_int64(argv[2]);

	std::reverse< char* >( ( char*)&t,(( char*)&t) + sizeof( int ) );
	std::reverse< char* >( ( char*)&begin,(( char*)&begin) + sizeof( int ) );
	std::reverse< char* >( ( char*)&end,(( char*)&end) + sizeof( int ) );
...
//}IPSeg_Match
//
SQLite_Fun sqlite_funs[]={

#ifdef _NO_BOOST_REGEX_
	{ "regex_match", 2, SQLITE_UTF8,    0, regex_match, 0, 0   },
#endif
	  { "time_match", 3, SQLITE_UTF8,    0, Time_Match, 0, 0   }
	,  { "inIPSeg", 3, SQLITE_UTF8,    0, IPSeg_Match, 0, 0   } };

SQLite_Fun* g_sqlite_fun = sqlite_funs;
#ifdef _NO_BOOST_REGEX_
int g_sqlite_fun_count = 3;
#else
