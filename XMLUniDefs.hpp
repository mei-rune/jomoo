...
const XMLCh chCaret                 = 0x5E; //^ 与6在同一个键上
const XMLCh chCloseAngle            = 0x3E; //>
const XMLCh chCloseCurly            = 0x7D; //}
const XMLCh chCloseParen            = 0x29; //)
const XMLCh chCloseSquare           = 0x5D; //[
const XMLCh chColon                 = 0x3A; // 冒号
const XMLCh chComma                 = 0x2C; // 逗点
const XMLCh chDash                  = 0x2D; // 破折号"-"
const XMLCh chDollarSign            = 0x24; // $
const XMLCh chDoubleQuote           = 0x22; // 双引号 {"}
const XMLCh chEqual                 = 0x3D; // 等于号 "="
const XMLCh chForwardSlash          = 0x2F; // 反斜号 "/"
const XMLCh chGrave                 = 0x60; // "`" 与~在同一个键上
...
const XMLCh chPeriod                = 0x2E; //.句号
const XMLCh chPipe                  = 0x7C; // | 或符
const XMLCh chPlus                  = 0x2B; // +
const XMLCh chPound                 = 0x23; // #
const XMLCh chQuestion              = 0x3F; // ?
const XMLCh chSingleQuote           = 0x27; // ' 单引号
const XMLCh chSpace                 = 0x20; // 空格
const XMLCh chSemiColon             = 0x3B; // ;
const XMLCh chTilde                 = 0x7E; // ~
const XMLCh chUnderscore            = 0x5F; // _ 下划线
